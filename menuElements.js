...
const help = () => {
  ...
  console.log('                  `                               \'');
  console.log('\n'); 
  console.log(`In this game you have 4 frogs. To finish a level you have to lead all of them towards the end points. End points are marked with the "F", "L", "O" and "W" letters. Use the "W" key to move up, "S" to move down, "A" to move left and "D" to move right. You have 60 seconds to finish the task but the goal is to be as quick as possible. Don't let cars to hit you on the road and avoid to drown in the river by using the tree logs when crossing it.`);
  console.log('\n');
  term.yellow();
  console.log(`Press "p" if you want to start the game and "q" if you want to quit.`);
};
